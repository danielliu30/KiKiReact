import { IconButton, Collapse, Card, CardMedia, Grid, Box, Typography, CardActions, CardContent, CardActionArea, makeStyles } from '@material-ui/core';
    ...
    return (
      <div>
        ...
        >
          ...
          >
            {categories.map(item =>
              <CategoryCard item={item} key={item.ItemVariation} addToCart={addToCart} />
            )}
          </Grid>
        </Box>
      </div>
