...
import { Button, InputLabel, Select, MenuItem, FormControl, FormControlLabel } from '@material-ui/core';
...
export default function PaymentForm(props) {
    ...
    const handlePress = (e) => {
        ...
        if (cardType != null) {
            let cardNum = e;
            if (cardType === parseInt(cardNum.substring(0, 2), 10) || cardType === parseInt(cardNum.charAt(0), 10)) {
                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12} md={6}>
                            <TextField
                                ...
                                inputRef={
                                    register({ minLength: { value: 4, message: "Too Short" } })
                                }
                            />
                        </Grid>
                        <Grid item xs={12} md={6}>
                        ...
                        <Grid item xs={12} md={6}>
                            <TextField inputRef={register} name="exp" required id="expDate" label="Expiry date" fullWidth autoComplete="cc-exp" />
                        </Grid>
                        <Grid item xs={12} md={6}>
                            <TextField
                                name="ccv"
                        ...
                        <Grid item xs={12}>
                            <FormControlLabel
                                control={<Checkbox inputRef={register} color="secondary" name="saveCard" />}
